...
public class CosmicShaderProgram
{
    ...
    public static void useShader(int shader, ShaderCallback callback)
    {
        ...
        if (shader != 0)
        {
            ...
            {
                ARBShaderObjects.glUniform1iARB(time, (int) (Games.world().getWorldTime() % Integer.MAX_VALUE));
            }
    ...
    /**
     * Most of the code taken from the <a href="http://lwjgl.org/wiki/index.php?title=GLSL_Shaders_with_LWJGL">LWJGL wiki</a>.
     */
    ...
    private static String readFileAsString(String filename) throws Exception
    {
        ...
        InputStream in = CosmicShaderProgram.class.getResourceAsStream(filename);
