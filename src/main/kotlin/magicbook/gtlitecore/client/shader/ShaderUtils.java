...
/**
 * {@link ShaderProgram} has generalized version of some methods in this class,
 * this is only a utility class and shader registry for legacy version.
 * <p>
 * Some codes referenced <a href="http://lwjgl.org/wiki/index.php?title=GLSL_Shaders_with_LWJGL">LWJGL wiki</a>.
 */
public class ShaderUtils
{
    ...
    private static final String PREFIX = "/assets/gtlitecore/shaders/";
     ...
     * @return     A shader program with ({@code vert}, {@code frag}).
     */
    ...
    private static int createShader(String filename, int shaderType)
    {
        ...
        catch (Exception e)
        {
            ...
            GTLiteLog.logger.error("Cannot creating shader, some OpenGL related render is error!");
            return -1;
        }
    }
