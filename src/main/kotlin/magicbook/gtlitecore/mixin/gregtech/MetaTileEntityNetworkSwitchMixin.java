...
public abstract class MetaTileEntityNetworkSwitchMixin extends MetaTileEntityDataBank
{

    public MetaTileEntityNetworkSwitchMixin(ResourceLocation metaTileEntityId)
    {
