...
class MagnetiumChain
{
    ...
    companion object
    {
        ...
        fun init()
        {
            ...
            ModHandler.addShapedRecipe(true, "magnetium_sheeted_frame", GTLiteUtility.copy(
                GTLiteMetaBlocks.SHEETED_FRAMES[Magnetium]!!.getItem(Magnetium), 12),
                "PFP", "PhP", "PFP",
            ...
            ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .outputs(GTLiteUtility.copy(GTLiteMetaBlocks.SHEETED_FRAMES[Magnetium]!!.getItem(Magnetium), 6))
                .EUt(7) // ULV
                .duration(2 * SECOND + 5 * TICK)
                .buildAndRegister()

            // wallGtMagnetium
            ModHandler.addShapedRecipe(true, "magnetium_wall_gt",
                GTLiteUtility.copy(GTLiteMetaBlocks.WALLS[Magnetium]!!.getItem(Magnetium), 6),
                "hPS", "P P", "SPd",
                'P', UnificationEntry(plate, Magnetium),
            ...
            ASSEMBLER_RECIPES.recipeBuilder()
                ...
                .outputs(GTLiteUtility.copy(GTLiteMetaBlocks.WALLS[Magnetium]!!.getItem(Magnetium), 3))
                .EUt(7)
                .duration(2 * SECOND + 5 * TICK)
                .buildAndRegister()
