...
class MetaTileEntityLargeElectrolyzer(metaTileEntityId: ResourceLocation?) : RecipeMapMultiblockController(metaTileEntityId, ELECTROLYZER_RECIPES)
{
    ...
    companion object
    {
        ...
        private val casingState
            get() = GTLiteMetaBlocks.METAL_CASING_01.getState(BlockMetalCasing01.MetalCasingType.POTIN)
    ...
    override fun createMetaTileEntity(tileEntity: IGregTechTileEntity) = MetaTileEntityLargeElectrolyzer(metaTileEntityId)
    ...
    private inner class LargeElectrolyzerRecipeLogic(metaTileEntity: RecipeMapMultiblockController) : MultiblockRecipeLogic(metaTileEntity)
    {
