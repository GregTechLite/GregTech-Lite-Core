...
public class MetaTileEntityLargeOreWasher extends MultiMapMultiblockController
{
    ...
    public MetaTileEntityLargeOreWasher(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, new RecipeMap[] {
                ...
                GTLiteRecipeMaps.CATALYTIC_REFORMER_RECIPES()
        });
        this.recipeMapWorkable = new LargeOreWasherRecipeLogic(this);
    }
    ...
    {
        return GTLiteMetaBlocks.METAL_CASING_01.getState(BlockMetalCasing01.MetalCasingType.GRISIUM);
    }
    ...
    {
        return GTLiteTextures.GRISIUM_CASING;
    }
    ...
    {
        return GTLiteTextures.LARGE_ORE_WASHER_OVERLAY;
    }
    ...
    protected class LargeOreWasherRecipeLogic extends MultiblockRecipeLogic
    {

        public LargeOreWasherRecipeLogic(RecipeMapMultiblockController tileEntity)
        {
            super(tileEntity);
        }
