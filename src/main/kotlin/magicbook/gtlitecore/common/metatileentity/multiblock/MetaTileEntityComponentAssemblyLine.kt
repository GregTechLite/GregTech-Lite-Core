...
import magicbook.gtlitecore.api.utils.StructureUtility.Companion.componentCasings
...
class MetaTileEntityComponentAssemblyLine(metaTileEntityId: ResourceLocation?) : RecipeMapMultiblockController(metaTileEntityId, COMPONENT_ASSEMBLY_LINE_RECIPES)
{
    ...
    companion object
    {
        ...
        private val thirdCasingState
            get() = GTLiteMetaBlocks.MULTIBLOCK_CASING_01.getState(BlockMultiblockCasing01.MultiblockCasingType.ADVANCED_FILTER_CASING)

        private val pipeCasingState
            get() = MetaBlocks.BOILER_CASING.getState(BlockBoilerCasing.BoilerCasingType.TUNGSTENSTEEL_PIPE)
    }

    override fun createMetaTileEntity(tileEntity: IGregTechTileEntity) = MetaTileEntityComponentAssemblyLine(metaTileEntityId)

    override fun formStructure(context: PatternMatchContext)
    {
        super.formStructure(context)
        val type: Any? = context.get<Any>("ComponentAssemblyCasingTieredStats")
    ...
    override fun getMatchingShapes(): List<MultiblockShapeInfo>
    {
        ...
        val builder = MultiblockShapeInfo.builder(LEFT, DOWN, FRONT)
            ...
            .aisle("HHHHHHHHH", "H  N N  H", "H  XXX  H", "H  JJJ  H", "H       H", "H       H", "HH HIH HH", " HHHSHHH ", "   HHH   ", "         ")
            .where('S', GTLiteMetaTileEntities.COMPONENT_ASSEMBLY_LINE, EnumFacing.SOUTH)
            .where('H', casingState)
            ...
            .where('D', MetaBlocks.FRAMES[HSLASteel]!!.getBlock(HSLASteel))
            .where('G', pipeCasingState)
            ...
            .where('N', MetaBlocks.FRAMES[TungstenSteel]!!.getBlock(TungstenSteel))
            ...
            .where('I', { if (ConfigHolder.machines.enableMaintenance) MetaTileEntities.MAINTENANCE_HATCH else casingState }, EnumFacing.SOUTH)
