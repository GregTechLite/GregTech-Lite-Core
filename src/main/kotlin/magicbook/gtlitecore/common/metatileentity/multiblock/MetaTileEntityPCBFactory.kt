...
class MetaTileEntityPCBFactory(metaTileEntityId: ResourceLocation?) : RecipeMapMultiblockController(metaTileEntityId, PCB_FACTORY_RECIPES)
{
    ...
    companion object
    {
        ...
        private val fifthCasingState
            get() = GTLiteMetaBlocks.METAL_CASING_03.getState(BlockMetalCasing03.MetalCasingType.OSMIRIDIUM)
        ...
        private val seventhCasingState
            get() = GTLiteMetaBlocks.METAL_CASING_03.getState(BlockMetalCasing03.MetalCasingType.NEUTRONIUM)
        private val eighthCasingState
            get() = GTLiteMetaBlocks.MULTIBLOCK_CASING_01.getState(BlockMultiblockCasing01.MultiblockCasingType.INFINITY_COOLING_CASING)
        ...
        private val turbineCasingState
            get() = MetaBlocks.MULTIBLOCK_CASING.getState(BlockMultiblockCasing.MultiblockCasingType.EXTREME_ENGINE_INTAKE_CASING)
    ...
    override fun checkRecipe(recipe: Recipe, consumeIfSuccess: Boolean): Boolean
    {
        return super.checkRecipe(recipe, consumeIfSuccess)
                && recipe.getProperty(PCBFactoryTieredProperty.getInstance(), 0)!! <= mainUpgradeNumber
