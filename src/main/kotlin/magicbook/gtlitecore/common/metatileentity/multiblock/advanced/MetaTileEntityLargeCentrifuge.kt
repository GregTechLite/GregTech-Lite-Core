...
public class MetaTileEntityLargeCentrifuge extends MultiMapMultiblockController
{
    ...
    public MetaTileEntityLargeCentrifuge(ResourceLocation metaTileEntityId)
    {
        ...
        this.recipeMapWorkable = new LargeCentrifugeRecipeLogic(this);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity)
    {
        return new MetaTileEntityLargeCentrifuge(metaTileEntityId);
    }
    ...
    private static IBlockState getCasingState() {
        return GTLiteMetaBlocks.METAL_CASING_01.getState(BlockMetalCasing01.MetalCasingType.TUMBAGA);
    }
    ...
    protected class LargeCentrifugeRecipeLogic extends MultiblockRecipeLogic
    {

        public LargeCentrifugeRecipeLogic(RecipeMapMultiblockController tileEntity)
        {
            super(tileEntity);
        }
        ...
        {
            return 8 * GTUtility.getTierByVoltage(this.getMaxVoltage());
        }
