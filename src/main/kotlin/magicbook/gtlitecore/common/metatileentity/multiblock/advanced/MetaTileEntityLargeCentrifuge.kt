...
class MetaTileEntityLargeCentrifuge(metaTileEntityId: ResourceLocation?) : MultiMapMultiblockController(metaTileEntityId, arrayOf(CENTRIFUGE_RECIPES, THERMAL_CENTRIFUGE_RECIPES))
{
    ...
    companion object
    {
        private val casingState
            get() = GTLiteMetaBlocks.METAL_CASING_01.getState(BlockMetalCasing01.MetalCasingType.TUMBAGA)
    ...
    override fun createMetaTileEntity(tileEntity: IGregTechTileEntity) = MetaTileEntityLargeCentrifuge(metaTileEntityId)
    ...
    override fun getMatchingShapes(): List<MultiblockShapeInfo>
    {
        ...
        val builder = MultiblockShapeInfo.builder(LEFT, DOWN, FRONT)
            ...
            .aisle("CCCCC", "C   C", "CCCCC")
            .aisle(" CCC ", "IJSKL", " CNC ")
            .where('S', GTLiteMetaTileEntities.LARGE_CENTRIFUGE, EnumFacing.SOUTH)
            .where('C', casingState)
    ...
    private inner class LargeCentrifugeRecipeLogic(metaTileEntity: RecipeMapMultiblockController) : MultiblockRecipeLogic(metaTileEntity)
    {
