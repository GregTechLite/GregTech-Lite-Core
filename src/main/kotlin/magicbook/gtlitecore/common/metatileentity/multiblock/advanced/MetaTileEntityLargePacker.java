...
public class MetaTileEntityLargePacker extends RecipeMapMultiblockController
{
    ...
    // =================================================================================================================
    public MetaTileEntityLargePacker(ResourceLocation metaTileEntityId)
    {
        super(metaTileEntityId, RecipeMaps.PACKER_RECIPES);
        this.recipeMapWorkable = new LargePackerRecipeLogic(this);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity)
    {
        return new MetaTileEntityLargePacker(metaTileEntityId);
    }
    ...
    protected void formStructure(PatternMatchContext context)
    {
        ...
        Object type = context.get("RobotArmCasingTieredStats");
    ...
    public List<MultiblockShapeInfo> getMatchingShapes()
    {
        ...
        StreamEx.of(GTLiteAPI.MAP_ROBOT_ARM_CASING.entrySet())
                .sortedByInt(entry -> ((WrappedIntTier) entry.getValue()).getIntTier())
                .forEach(entry -> shapeInfo.add(builder.where('R', entry.getKey()).build()));
        return shapeInfo;
    }
    ...
    protected class LargePackerRecipeLogic extends MultiblockRecipeLogic
    {

        public LargePackerRecipeLogic(RecipeMapMultiblockController tileEntity)
        {
            super(tileEntity);
        }
