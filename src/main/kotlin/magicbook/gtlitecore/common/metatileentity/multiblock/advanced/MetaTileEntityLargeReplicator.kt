...
public class MetaTileEntityLargeReplicator extends RecipeMapMultiblockController
{
    ...
    {
        return new MetaTileEntityLargeReplicator(metaTileEntityId);
    }
    ...
    {
        return GTLiteMetaBlocks.METAL_CASING_02.getState(BlockMetalCasing02.MetalCasingType.RENE_N5);
    }
    ...
    {
        return GTLiteTextures.RENE_N5_CASING;
    }
        ...
        StreamEx.of(fieldGenCasings)
                .map(b -> {
                    if (builder != null) {
                        ...
                        builder.where('P', processorCasings.get(count.get()));
    ...
    protected class LargeReplicatorRecipeLogic extends MultiblockRecipeLogic
    {

        public LargeReplicatorRecipeLogic(RecipeMapMultiblockController tileEntity)
        {
            super(tileEntity);
        }
        ...
        {
            return 4 * Math.min(getFieldGenCasingTier(), getProcessorCasingTier());
        }
