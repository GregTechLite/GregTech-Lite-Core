...
class MetaTileEntityAdvancedEnergyHatch(metaTileEntityId: ResourceLocation?, tier: Int, amperage: Int, isExportHatch: Boolean) : MetaTileEntityEnergyHatch(metaTileEntityId, tier, amperage, isExportHatch), IMultiblockAbilityPart<IEnergyContainer>, IQuantumStorage<IEnergyContainer>
{
