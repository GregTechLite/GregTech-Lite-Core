...
public class BlockTimeAccelerationFieldGenerator extends VariantBlock<BlockTimeAccelerationFieldGenerator.FieldGeneratorTier>
{

    public BlockTimeAccelerationFieldGenerator()
    {
        super(Material.IRON);
        this.setTranslationKey("time_acceleration_field_generator");
