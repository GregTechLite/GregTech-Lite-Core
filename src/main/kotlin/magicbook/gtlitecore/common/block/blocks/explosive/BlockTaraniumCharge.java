...
public class BlockTaraniumCharge extends BlockGTExplosive
{

    public BlockTaraniumCharge()
    {
        super(Material.TNT, true, true, 30 * SECOND);
        this.setHardness(0);
    ...
    protected EntityGTExplosive createEntity(World world, BlockPos pos, EntityLivingBase exploder)
    {
        ...
        return new EntityTaraniumCharge(world, x, y, z, exploder);
    }
                               ...
                               @NotNull ITooltipFlag flag)
    {
        ...
        tooltip.add(I18n.format("tile.taranium_charge.tooltip.1"));
        tooltip.add(I18n.format("tile.taranium_charge.tooltip.2"));
    }
