...
public class BlockNuclearReactorCore01 extends VariantActiveBlock<BlockNuclearReactorCore01.ReactorCoreType>
{

    public BlockNuclearReactorCore01()
    {
        super(Material.IRON);
        this.setTranslationKey("nuclear_reactor_core_01");
