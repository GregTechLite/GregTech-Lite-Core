...
public class BlockGlassCasing01 extends VariantBlock<BlockGlassCasing01.GlassType>
{

    public BlockGlassCasing01()
    {
        super(Material.GLASS);
        this.setTranslationKey("glass_casing_01");
        this.setHardness(5.0F);
        this.setResistance(5.0F);
        this.setSoundType(SoundType.GLASS);
        this.setHarvestLevel("pickaxe", 1);
        this.setDefaultState(this.getState(GlassType.PMMA));
                               ...
                               ITooltipFlag advanced)
    {
        ...
        VariantItemBlock itemBlock = (VariantItemBlock<BlockGlassCasing01.GlassType, BlockGlassCasing01>) stack.getItem();
        IBlockState stackState = itemBlock.getBlockState(stack);
        BlockGlassCasing01.GlassType glassType =  this.getState(stackState);
    ...
    {
        PMMA("pmma", GTValues.UHV),
        BPA_POLYCARBONATE("bpa_polycarbonate", GTValues.ZPM),
        CBDO_POLYCARBONATE("cbdo_polycarbonate", GTValues.UEV),
        ZBLAN("zblan", GTValues.UV),
        ERBIUM_ZBLAN("erbium_zblan", GTValues.UHV),
