...
public class BlockComputerCasing01 extends VariantBlock<BlockComputerCasing01.ComputerCasingType>
{

    public BlockComputerCasing01()
    {
        super(Material.IRON);
        this.setTranslationKey("computer_casing_01");
        this.setHardness(5.0F);
        this.setResistance(10.0F);
        this.setSoundType(SoundType.METAL);
        this.setHarvestLevel("wrench", 2);
        this.setDefaultState(this.getState(ComputerCasingType.MOLECULAR_CASING));
    }
