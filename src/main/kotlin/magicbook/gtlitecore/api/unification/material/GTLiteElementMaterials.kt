...
import magicbook.gtlitecore.api.unification.material.element.GTLiteElements.Companion.Mx
        ...
        fun init()
        {
            ...
            Vibranium = Material.Builder(2, gtliteId("vibranium"))
                ...
                .flags(EXT2_METAL, GENERATE_FRAME, GENERATE_GEAR, GENERATE_SMALL_GEAR,
                    ...
                    GENERATE_FOIL, GENERATE_FINE_WIRE, GENERATE_ROUND)
                .blast { b ->
            ...
            // 18 Mag Matter
            MagMatter = Material.Builder(18, gtliteId("mag_matter"))
                .ingot()
                .liquid()
                .iconSet(MAGMATTER)
                .element(Mx)
