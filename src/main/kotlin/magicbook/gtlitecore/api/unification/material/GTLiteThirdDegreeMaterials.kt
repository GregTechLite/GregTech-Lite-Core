...
import magicbook.gtlitecore.api.unification.material.infos.GTLiteMaterialIconSet.Companion.AEROTHEUM
import magicbook.gtlitecore.api.unification.material.infos.GTLiteMaterialIconSet.Companion.CRYOTHEUM
import magicbook.gtlitecore.api.unification.material.infos.GTLiteMaterialIconSet.Companion.PETROTHEUM
import magicbook.gtlitecore.api.unification.material.infos.GTLiteMaterialIconSet.Companion.PYROTHEUM
...
class GTLiteThirdDegreeMaterials
{
    ...
    companion object
    {
        ...
        fun init()
        {
            ...
            // 6001 Limestone
            Limestone = Material.Builder(6001, gtliteId("limestone"))
                .dust()
            ...
            // 6002 Komatiite
            Komatiite = Material.Builder(6002, gtliteId("komatiite"))
                .dust()
            ...
            // 6003 Green Schist
            GreenSchist = Material.Builder(6003, gtliteId("green_schist"))
                .dust()
            ...
            // 6004 Blue Schist
            BlueSchist = Material.Builder(6004, gtliteId("blue_schist"))
                .dust()
            ...
            // 6005 Kimberlite
            Kimberlite = Material.Builder(6005, gtliteId("kimberlite"))
                .dust()
            ...
            // 6006 Slate
            Slate = Material.Builder(6006, gtliteId("slate"))
                .dust()
            ...
            // 6007 Shale
            Shale = Material.Builder(6007, gtliteId("shale"))
                .dust()
            ...
            BlazingPyrotheum = Material.Builder(6011, gtliteId("blazing_pyrotheum"))
                .dust()
                .liquid(FluidBuilder()
            ...
            GelidCryotheum = Material.Builder(6012, gtliteId("gelid_cryotheum"))
                .dust()
                .liquid(FluidBuilder()
                    .translation("gregtech.fluid.generic")
                    .temperature(2)
            ...
            TectonicPetrotheum = Material.Builder(6013, gtliteId("tectonic_petrotheum"))
                .dust()
                .liquid(FluidBuilder()
                    .translation("gregtech.fluid.generic")
                    .temperature(350)
            ...
            ZephyreanAerotheum = Material.Builder(6014, gtliteId("zephyrean_aerotheum"))
                .dust()
                .liquid(FluidBuilder()
                    .translation("gregtech.fluid.generic")
                    .temperature(600)
            ...
            // 6015 Sienna
            Sienna = Material.Builder(6015, gtliteId("sienna"))
                .dust()
                .color(0x4A3724)
            ...
            // 6016 Burnt Sienna
            BurntSienna = Material.Builder(6016, gtliteId("burnt_sienna"))
                .dust()
                .color(0x662E2E)
                .components(ManganeseMonoxide, 1, BandedIron, 1)
                .flags(DECOMPOSITION_BY_CENTRIFUGING)
            ...
            SuperheatedSteam = Material.Builder(6026, gtliteId("superheated_steam"))
            ...
            SuperheatedSodiumPotassiumEutatic = Material.Builder(6027, gtliteId("superheated_sodium_potassium_eutatic"))
            ...
            SuperheatedLeadBismuthEutatic = Material.Builder(6028, gtliteId("superheated_lead_bismuth_eutatic"))
            ...
            SuperheatedLithiumSodiumPotassiumFluorides = Material.Builder(6029, gtliteId("superheated_lithium_sodium_potassium_fluorides"))
            ...
            SuperheatedLithiumBerylliumFluorides = Material.Builder(6030, gtliteId("superheated_lithium_beryllium_fluorides"))
            ...
            SupercriticalSteam = Material.Builder(6031, gtliteId("supercritical_steam"))
            ...
            SupercriticalSodiumPotassiumEutatic = Material.Builder(6032, gtliteId("supercritical_sodium_potassium_eutatic"))
            ...
            SupercriticalLeadBismuthEutatic = Material.Builder(6033, gtliteId("supercritical_lead_bismuth_eutatic"))
            ...
            SupercriticalLithiumSodiumPotassiumFluorides = Material.Builder(6034, gtliteId("supercritical_lithium_sodium_potassium_fluorides"))
            ...
            SupercriticalLithiumBerylliumFluorides = Material.Builder(6035, gtliteId("supercritical_lithium_beryllium_fluorides"))
