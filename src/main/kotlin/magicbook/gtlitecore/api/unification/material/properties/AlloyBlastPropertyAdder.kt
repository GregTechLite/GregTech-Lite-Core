...
class AlloyBlastPropertyAdder
{
    ...
    companion object
    {
        ...
        {
            // NbN
            var property: AlloyBlastProperty = Materials.NiobiumNitride.getProperty(GTLitePropertyKey.ALLOY_BLAST)
        ...
        {
            val components: List<MaterialStack> = material.materialComponents
