...
@Deprecated(message = "THIS IS A LEGACY RECIPEMAP UI, IT IS DEPRECATED NOW!",
            replaceWith = ReplaceWith("magicbook.gtlitecore.api.recipe.ui.MiningDroneUI"),
            level = DeprecationLevel.WARNING)
@ApiStatus.Internal
@Suppress("UnstableApiUsage", "MISSING_DEPENDENCY_CLASS")
class MiningDroneAirportUILegacy<R: RecipeMap<*>>(recipeMap: R) : RecipeMapUI<R>(recipeMap, true, true, true, true, false)
{
