...
// This class is port from schedule removal class in Gregtech,
// because we used XSTR algorithm in WorldGen system or EventHandlers.

import java.util.Random;
import java.util.concurrent.atomic.AtomicLong;

/**
 * A subclass of {@link java.util.Random} that implements the Xor-Shift random number generator.
 *
 * @author <a href=" http://www.elmenreich.tk">Wilfried Elmenreich University of Klagenfurt/Lakeside Labs</a>
 *
 * <p>
 ...
 *     provides a clone() function. Usage:
 *     <pre>{@code
 *         XSTR rand = new XSTR(); // Instantiation x = rand.nextInt();
 *         // ...
 *         // Will pull a random number via XSTR().
 *     }</pre>
 *     To use the class in legacy code, you may also instantiate an XSTR object,
 *     and assign it to a {@link java.util.Random} object:
 *     <pre>{@code
 *         Random rand = new XSTR();
 *     }</pre>
 *     For an explanation of the algorithm, please see: <a href="http://demesos.blogspot.com/
 *     2011/09/pseudo-random-number-generators.html">Pseudo Random Number Generator</a>.
 * </p>
 * <p>
 *     This code is released under the GNU Lesser General Public License Version 3
 *     please see: <a href="http://www.gnu.org/licenses/lgpl-3.0.txt">LICENSE</a>.
 * </p>
 */
public class XSTR extends Random // XSTR: Xor-Shift Thermite Random
{
     ...
     * see <a href="http://www.javamex.com/tutorials/random_numbers/xorshift.shtml">XSTR Tutorials</a>.
     */
