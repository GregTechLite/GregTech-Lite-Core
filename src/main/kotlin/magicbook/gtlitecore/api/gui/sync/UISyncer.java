package magicbook.gtlitecore.api.gui.sync;

import com.cleanroommc.modularui.utils.serialization.ByteBufAdapters;
import com.cleanroommc.modularui.utils.serialization.IByteBufAdapter;
import com.cleanroommc.modularui.utils.serialization.IByteBufDeserializer;
import com.cleanroommc.modularui.utils.serialization.IByteBufSerializer;
import magicbook.gtlitecore.api.gui.adapter.GTByteBufAdapters;
...
public interface UISyncer
{
    ...
    default <T> T syncObject(T initial,
    ...
    <T> T syncObject(@NotNull Supplier<@NotNull T> initial,
                     IByteBufSerializer<T> serializer,
                     IByteBufDeserializer<T> deserializer);

    default <T> T syncObject(@NotNull Supplier<@NotNull T> initial,
     ...
     * @return the synced collection
     */
    default <T, C extends Collection<T>> C syncCollection(C initial,
                                                          IByteBufAdapter<T> adapter)
    {
     ...
     * @return on the server, the initial array, otherwise the synced array copy
     */
    default <T> T[] syncArray(T[] initial,
                              IByteBufAdapter<T> adapter)
    {
