                                             ...
                                             JeiIngredientProvider
{
    ...
    public void drawForeground(ModularGuiContext context)
    {
        ...
        if (getHoveredElement() instanceof IHoverable)
        {
            IHoverable hoverable = (IHoverable) getHoveredElement();
            hoverable.onHover();
        ...
        if (getHoveredElement() instanceof IconAccessor
                && ((IconAccessor) getHoveredElement()).gtlitecore$getDrawable() instanceof JeiIngredientProvider)
        {
            IconAccessor accessor = (IconAccessor) getHoveredElement();
            JeiIngredientProvider provider = (JeiIngredientProvider) accessor.gtlitecore$getDrawable();
    ...
    public Result onMousePressed(int mouseButton)
    {
        ...
        if (getHoveredElement() instanceof Interactable)
        {
            Interactable interactable = (Interactable) getHoveredElement();
