        ...
        return GTGuis.createPanel(this, 180, 110)
            .child(Flow.column()
                       ...
                       .child(Flow.row()
                                  ...
                                  .marginBottom(2)
                                  .widthRel(1f)
                                  .child(IKey.lang("gtlitecore.machine.wireless_energy_hatch.channel").asWidget()
                                             .width(90))
                       ...
                       .child(Flow.row()
                                  ...
                                  .marginBottom(2)
                                  .widthRel(1f)
                                  .child(IKey.lang("gtlitecore.machine.wireless_energy_hatch.priority").asWidget()
                                             .width(90))
                                  .child(TextFieldWidget()
                                             .width(80)
                       ...
                       .child(Flow.row()
                                  ...
                                  .marginBottom(2)
                                  .widthRel(1f)
                                  .child(IKey.lang("gtlitecore.machine.wireless_energy_hatch.amperage").asWidget()
                                             .width(90))
                                  .child(ButtonWidget()
                                             .width(18)
                                             .onMouseTapped {
                       ...
                       .child(Flow.row()
                                  ...
                                  .marginBottom(2)
                                  .widthRel(1f)
                                  .child(IKey.lang("gtlitecore.machine.wireless_energy_hatch.buffer_duration").asWidget()
                                             .width(90))
                                  .child(SliderWidget()
                                             .width(50)
