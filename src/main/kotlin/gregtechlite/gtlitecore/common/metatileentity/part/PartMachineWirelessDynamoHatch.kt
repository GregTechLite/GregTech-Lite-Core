...
class PartMachineWirelessDynamoHatch(id: ResourceLocation, tier: Int, initialAmperage: Int = 2)
    : PartMachineWirelessHatch(id, tier, initialAmperage)
{
    ...
    {
        energyContainer = object : EnergyContainerHandler(this, V[tier] * 64L * amperage, 0L, 0L, V[tier], amperage.toLong())
        {
            override fun getEnergyCapacity(): Long = V[tier] * 64L * amperage

            override fun getOutputVoltage(): Long = V[tier]
    ...
    override fun createMetaTileEntity(te: IGregTechTileEntity): MetaTileEntity
        = PartMachineWirelessDynamoHatch(metaTileEntityId, tier, amperage)

    override fun getAbility(): MultiblockAbility<IEnergyContainer> = MultiblockAbility.OUTPUT_ENERGY
