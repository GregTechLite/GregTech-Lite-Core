...
import gregtech.api.capability.GregtechDataCodes.UPDATE_AUTO_OUTPUT
                               ...
                               private val color: Int, private val tankSize: Int) : MetaTileEntity(id)
{
    ...
    constructor(id: ResourceLocation, material: Material, tankSize: Int)
            : this(id, material.getProperty(PropertyKey.FLUID_PIPE), material.materialRGB, tankSize)
    ...
    override fun onRightClick(playerIn: EntityPlayer, hand: EnumHand, facing: EnumFacing?,
                              hitResult: CuboidRayTraceResult?): Boolean
    {
        return if (!playerIn.getHeldItem(hand).hasCapability(
    ...
    override fun onScrewdriverClick(playerIn: EntityPlayer, hand: EnumHand?, wrenchSide: EnumFacing?,
                                    hitResult: CuboidRayTraceResult?): Boolean
    {
    ...
    override fun addInformation(stack: ItemStack, player: World?, tooltip: MutableList<String>, advanced: Boolean)
    {
        ...
        fluidFilter!!.appendTooltips(tooltip, true, true)
    ...
    private fun toggleOutput()
    {
        ...
        {
            notifyBlockUpdate()
            writeCustomData(UPDATE_AUTO_OUTPUT) { it.writeBoolean(isAutoOutput) }
            markDirty()
        }
    }
