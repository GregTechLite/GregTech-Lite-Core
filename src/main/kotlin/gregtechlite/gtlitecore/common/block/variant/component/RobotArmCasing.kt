...
enum class RobotArmCasing(private val serializedName: String,
                                                               ...
                                                               IStateHarvestLevel, StateTier
{
    ...
    override val state: IBlockState
        get() = GTLiteMetaBlocks.ROBOT_ARM_CASING.getState(this)

    override val tier: Int
        get() = ordinal + 1

    override fun getStack(count: Int): ItemStack = GTLiteMetaBlocks.ROBOT_ARM_CASING.getItemVariant(this, count)
