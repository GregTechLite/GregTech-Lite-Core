...
enum class SensorCasing(private val serializedName: String,
                                                             ...
                                                             IStateHarvestLevel, StateTier
{
    ...
    override val state: IBlockState
        get() = GTLiteMetaBlocks.SENSOR_CASING.getState(this)

    override val tier: Int
        get() = ordinal + 1

    override fun getStack(count: Int): ItemStack = GTLiteMetaBlocks.SENSOR_CASING.getItemVariant(this, count)
