...
enum class PumpCasing(private val serializedName: String,
                                                           ...
                                                           IStateHarvestLevel, StateTier
{
    ...
    override val state: IBlockState
        get() = GTLiteMetaBlocks.PUMP_CASING.getState(this)

    override val tier: Int
        get() = ordinal + 1

    override fun getStack(count: Int): ItemStack = GTLiteMetaBlocks.PUMP_CASING.getItemVariant(this, count)
