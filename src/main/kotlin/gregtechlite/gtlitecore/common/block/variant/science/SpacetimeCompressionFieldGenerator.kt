...
enum class SpacetimeCompressionFieldGenerator(private val serializedName: String,
                                              private val harvestLevel: Int = 2) : BlockVariant, IStringSerializable, IStateHarvestLevel
{
    ...
    override val state: IBlockState
        get() = GTLiteMetaBlocks.SPACETIME_COMPRESSION_FIELD_GENERATOR.getState(this)

    override fun getStack(count: Int): ItemStack =
        GTLiteMetaBlocks.SPACETIME_COMPRESSION_FIELD_GENERATOR.getItemVariant(this, count)
