...
class BlockNaquadriaCharge : BlockGTExplosive(Material.TNT, true, true, 10 * SECOND)
{
    ...
    override fun createEntity(world: World?, pos: BlockPos, exploder: EntityLivingBase?): EntityGTExplosive
    {
        ...
        val y = pos.y.toFloat()
        val z = pos.z + 0.5f
        return EntityNaquadriaCharge(world, x.toDouble(), y.toDouble(), z.toDouble(), exploder)
    }
                                ...
                                flag: ITooltipFlag)
    {
        ...
        tooltip.add(I18n.format("tile.gtlitecore.naquadria_charge.tooltip.1"))
        tooltip.add(I18n.format("tile.gtlitecore.naquadria_charge.tooltip.2"))
    }
