...
inline fun <reified T> VariantBlockFactory.makeMetalActiveBlock() : VariantActiveBlock<T> where T : Enum<T>, T : IStringSerializable
{
    return object: VariantActiveBlock<T>(Material.IRON)
    {
