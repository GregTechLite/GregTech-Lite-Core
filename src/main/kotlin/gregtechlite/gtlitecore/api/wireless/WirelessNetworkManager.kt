...
object WirelessNetworkManager {
    ...
    private fun List<WirelessEnergyHolder>.byPriority(): List<WirelessEnergyHolder> =
     ...
     */
    private fun distributeOutputsToInputs(
     ...
     */
    private fun fillInputsFromStorages(
        inputs: List<WirelessEnergyHolder>,
     ...
     */
    private fun storeRemainingOutputs(
        outputs: List<WirelessEnergyHolder>,
        storages: List<WirelessEnergyHolder>
    ) {
        for (output in outputs) {
