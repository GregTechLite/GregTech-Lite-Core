    ...
    fun init()
    {
        ...
        ASSEMBLY_LINE_RECIPES.removeRecipe(
            ...
            arrayOf(SolderingAlloy.getFluid(L * 2),
                    ...
                    StyreneButadieneRubber.getFluid(L * 16)))
        ...
        // UV
        RESEARCH_STATION_RECIPES.removeRecipe(CONVEYOR_MODULE_ZPM.stackForm, TOOL_DATA_ORB.stackForm)
        ...
        ASSEMBLY_LINE_RECIPES.removeRecipe(
            ...
            arrayOf(SolderingAlloy.getFluid(L * 4),
                    ...
                    StyreneButadieneRubber.getFluid(L * 24),
