...
internal object HeatExchangeChain
{
    ...
    fun init()
    {
        // 1L   Water / Distilled Water -> 160L Steam -> 1L Distilled Water
        // 320L SuperheatedSteam        -> 320L Steam -> 2L Distilled Water
        // 640L SupercriticalSteam      -> 640L Steam -> 4L Distilled Water

        // Superheated Steam
        HOT_COOLANT_TURBINE_FUELS.addRecipe {
        ...
        // Supercritical Steam
        SUPERCRITICAL_FLUID_TURBINE_FUELS.addRecipe {
