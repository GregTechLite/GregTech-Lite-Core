...
internal object NanotubesChain
{
    ...
    private fun cppProcess()
    {
        ...
        CHEMICAL_PLANT_RECIPES.addRecipe {
            notConsumable(dust, Bipyridine)                        // catalyst C10H8N2
            notConsumable(dust, PalladiumBisdibenzylidieneacetone) // catalyst C51H42O3Pd2
            input(dust, Dichlorocyclooctadieneplatinium, 46)                // C8H12Cl2Pt
            input(dust, Diiodobiphenyl, 44)                                 // C12H8I2
            input(dust, SilverTetrafluoroborate, 24)                        // AgBF4
            input(dust, Carbon, 8)
            notConsumable(Resorcinol.getFluid(1))                  // catalyst C6H6O2
            notConsumable(Butyllithium.getFluid(1))                // catalyst C4H9Li
            fluidInputs(TrimethyltinChloride.getFluid(4000))       //          (CH3)3SnCl
            output(dust, PalladiumRaw, 6)
            output(dust, Iodine, 8)
            output(dust, SilverChloride, 8)
            output(dust, Tin, 4)
            fluidOutputs(Cycloparaphenylene.getFluid(10000))                // C6H4
    ...
    private fun lanthanumFullereneNTProcess()
    {
        ...
        // 2(C60)2La2 + 12C2H2 + 28C6H4 + 4N -> 4C48C60La + 40NH3
        PLASMA_CVD_RECIPES.addRecipe {
