...
internal object QuarksChain
{
    ...
    fun init()
    {
        // region Quark-Gluon Plasma and HQDM Processing
        ...
        // region High Energy Quark-Gluon Plasma and QCM Processing

        // Tier 1: 144L HQDM -> 1000L High Energy Quark-Gluon Plasma
        STELLAR_FORGE_RECIPES.addRecipe {
            circuitMeta(1)
