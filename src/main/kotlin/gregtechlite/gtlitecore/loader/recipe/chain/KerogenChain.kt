...
import gregtechlite.gtlitecore.common.block.adapter.GTPlankBlock
...
internal object KerogenChain
{
    ...
    fun init()
    {
        ...
        DISTILLATION_RECIPES.removeRecipe(OilLight.getFluid(150))
        ...
        // Medium Oil
        DISTILLATION_RECIPES.removeRecipe(RawOil.getFluid(100))
        ...
        // Heavy Oil
        DISTILLATION_RECIPES.removeRecipe(OilHeavy.getFluid(100))
        ...
        // Treated Wood
        ModHandler.addShapedRecipe(false, "treated_wood_planks", GTPlankBlock.TREATED_PLANK.getStack(8),
            "PPP", "PBP", "PPP",
            'P', "plankWood",
