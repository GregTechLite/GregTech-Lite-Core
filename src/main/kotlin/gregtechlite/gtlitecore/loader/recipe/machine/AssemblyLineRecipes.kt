...
internal object AssemblyLineRecipes
{
    ...
    {
        // LuV Energy Hatch
        SCANNER_RECIPES.removeRecipe(TOOL_DATA_STICK.stack(), ENERGY_INPUT_HATCH[IV].stack())
        ASSEMBLY_LINE_RECIPES.removeRecipe(
            arrayOf(HULL[LuV].stack(),
            ...
            arrayOf(SodiumPotassium.getFluid(6000),
                    SolderingAlloy.getFluid(L * 5)))
        ...
        // LuV Dynamo Hatch
        SCANNER_RECIPES.removeRecipe(TOOL_DATA_STICK.stack(), ENERGY_OUTPUT_HATCH[IV].stack())
        ASSEMBLY_LINE_RECIPES.removeRecipe(
            arrayOf(HULL[LuV].stack(),
        ...
        // ZPM Energy Hatch
        RESEARCH_STATION_RECIPES.removeRecipe(TOOL_DATA_ORB.stack(), ENERGY_INPUT_HATCH[LuV].stack())
        ASSEMBLY_LINE_RECIPES.removeRecipe(
            arrayOf(HULL[ZPM].stack(),
            ...
            arrayOf(SodiumPotassium.getFluid(8000),
        ...
        // ZPM Dynamo Hatch
        RESEARCH_STATION_RECIPES.removeRecipe(TOOL_DATA_ORB.stack(), ENERGY_OUTPUT_HATCH[LuV].stack())
        ASSEMBLY_LINE_RECIPES.removeRecipe(
            arrayOf(HULL[ZPM].stack(),
        ...
        // UV Energy Hatch
        RESEARCH_STATION_RECIPES.removeRecipe(TOOL_DATA_MODULE.stack(), ENERGY_INPUT_HATCH[ZPM].stack())
        ASSEMBLY_LINE_RECIPES.removeRecipe(
            arrayOf(HULL[UV].stack(),
                    OreDictUnifier.get(cableGtSingle, YttriumBariumCuprate, 4),
                    ULTRA_HIGH_POWER_INTEGRATED_CIRCUIT.getStackForm(2),
                    OreDictUnifier.get(circuit, Tier.UV),
                    VOLTAGE_COIL_UV.getStackForm(2)),
            arrayOf(SodiumPotassium.getFluid(10000),
        ...
        // UV Dynamo Hatch
        RESEARCH_STATION_RECIPES.removeRecipe(TOOL_DATA_MODULE.stack(), ENERGY_OUTPUT_HATCH[ZPM].stack())
        ASSEMBLY_LINE_RECIPES.removeRecipe(
            arrayOf(HULL[UV].stack(),
        ...
        // UHV Energy Hatch
        RESEARCH_STATION_RECIPES.removeRecipe(TOOL_DATA_MODULE.stack(), ENERGY_INPUT_HATCH[UV].stack())
        ASSEMBLY_LINE_RECIPES.removeRecipe(
            arrayOf(HULL[UHV].stack(),
            ...
            arrayOf(SodiumPotassium.getFluid(12000),
                    SolderingAlloy.getFluid(L * 40)))
        ...
        // UHV Dynamo Hatch
        RESEARCH_STATION_RECIPES.removeRecipe(TOOL_DATA_MODULE.stack(), ENERGY_OUTPUT_HATCH[UV].stack())
        ASSEMBLY_LINE_RECIPES.removeRecipe(
            arrayOf(HULL[UHV].stack(),
