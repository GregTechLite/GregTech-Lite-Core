...
internal object IntegratedCircuits
{
    ...
    private fun smdRecipes()
    {
        ...
        // Resistor
        ModHandler.addShapedRecipe(true, "resistor_wire_lignite", RESISTOR.getStack(2),
            "RPR", "CDC", " P ",
            'R', STICKY_RESIN,
        ...
        ModHandler.addShapedRecipe(true, "resistor_wire_fine_lignite", RESISTOR.getStack(2),
            "RPR", "CDC", " P ",
            'R', STICKY_RESIN,
            'P', ItemStack(Items.PAPER),
